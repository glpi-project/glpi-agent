...
sub getInterfaces {
    ...
    my @networkAdapter = getWMIObjects(
        ...
        properties => [ qw/InterfaceIndex PnPDeviceID Speed HardwareInterface InterfaceGuid InterfaceDescription InterfaceType Name MediaConnectState Virtual/ ]
    );
    ...
    if (!@networkAdapter) {
        ...
        @networkAdapter = getWMIObjects(
            ...
            properties => [ qw/Index InterfaceIndex PNPDeviceID Speed PhysicalAdapter GUID NetConnectionID NetConnectionStatus/ ]
        );
    }
