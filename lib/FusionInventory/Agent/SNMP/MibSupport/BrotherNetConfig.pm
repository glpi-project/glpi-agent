package FusionInventory::Agent::SNMP::MibSupport::BrotherNetConfig;
...
FusionInventory::Agent::SNMP::MibSupport::BrotherNetConfig - Inventory module for Brother Printers
