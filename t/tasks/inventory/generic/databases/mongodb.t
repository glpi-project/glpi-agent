...
use FusionInventory::Agent::Task::Inventory::Generic::Databases::MongoDB;
...
foreach my $test (keys %db_tests) {
    ...
    my $dbs   = FusionInventory::Agent::Task::Inventory::Generic::Databases::MongoDB::_getDatabaseService(
        file        => $file,
